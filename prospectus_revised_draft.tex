...
PhD Prospectus\\[2em]
{\bfseries BEYOND ISOLATED OBSERVATIONS:\\
MEASURING AND MITIGATING RISKS ACROSS MOBILE APPLICATIONS,\\
PERMISSIONS, AND CONVERSATIONS}\\[2em]
By\\[1em]
OLAWALE AMOS AKANJI\\
...
warnings over text alone. The central question is how contextual evidence within
applications, operating-system mechanisms, and conversations can be translated
into useful protection while preserving user privacy and controlling false alarms.
The dissertation will distinguish demonstrated findings
...
\textbf{Thesis proposition.} \emph{Many mobile harms cannot be identified from
an application listing, permission prompt, or message viewed in isolation because
the relevant evidence emerges from application behavior, changes in access, and
interaction context. This dissertation argues that measuring this evidence across
applications, operating-system mechanisms, and conversations can support practical
interventions whose value must be established through accuracy, timeliness, user
visibility, privacy, and deployment cost.}
